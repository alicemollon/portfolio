...
$(document).ready(function(){var i=$("section#images").imagesLoaded().always(function(){i.isotope({filter:".illustration"}),i.fadeTo(2e3,1)});$("nav a").on("click",function(){var t=$(this).attr("data-category");return i.isotope({filter:"div."+t}),!1}),$(".illustration .nudge").on("click",function(){$("div#lightbox").fadeIn(250);var i=$(this).clone().removeClass("nudge");$("div#lightbox").html(i)}),$("div#lightbox").on("click",function(){$("div#lightbox").fadeOut(250)})});